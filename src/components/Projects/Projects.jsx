										...
										>
											...
											>
												...
												<p className='projects-section-text'>
													...
													responsive UI designs that
													improved accessibility and
													usability, contributing to
												...
												<p className='projects-section-text'>
													...
													guides for frontend components and
													APIs, reducing ramp-up time for
													new hires and contractors by 30%.
												</p>
												<p className='projects-section-text'>
													<strong>
												...
												<p className='projects-section-text'>
													...
													Integrated frontend monitoring
													tools like Sentry and Google
													Lighthouse to proactively identify
													and resolve performance
												...
												<p className='projects-section-text'>
													...
													retrospectives, helping the team
													maintain high velocity and adapt
