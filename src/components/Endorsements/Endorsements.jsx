          ...
          <div className="wp-block-columns alignwide is-layout-flex wp-container-core-columns-layout-31 wp-block-columns-is-layout-flex">
            <div className="wp-block-column is-layout-flow wp-container-core-column-layout-40 wp-block-column-is-layout-flow">
              <p className="has-background-color has-text-color has-link-color wp-elements-748c6fdb72b926c49d219f0d66ab87b2 endorsements-section-text">
                “I had the pleasure of working with David on a major initiative
                to bring a paperless patient platform to dental practices,
                revolutionizing how patient data is collected and improving
                overall efficiency. David's technical expertise and commitment
                to collaboration made him an invaluable member of our team.
                <br />
                <br />
                David excelled in grooming sessions, consistently asking
                thoughtful questions and seeking clarity to ensure tasks were
                understood and executed with precision. Throughout our sprints,
                he effectively used tools like Jira to communicate progress and
                address any roadblocks, demonstrating a proactive and
                solutions-oriented mindset. His punctuality and engagement were
                evident in his on-time task delivery, active participation in
                daily standups, and clear demonstrations of his work. David's
                responsiveness to feedback and his ability to incorporate
                changes seamlessly ensured the success of our project
                deliverables.
                <br />
                <br />
                Beyond his technical skills, David showcased a deep
                understanding of the daily operations of a dental office, which
                added immense value to the platform. By listening and learning
                from end users, he contributed to creating a product that truly
                addressed the needs of dental practices. David's proficiency in
                front-end frameworks like React and Angular, paired with his
                collaborative approach, allowed him to deliver high-quality,
                user-friendly web applications. His use of debugging tools,
                optimization techniques, and commitment to coding best practices
                enhanced the performance and reliability of our solutions.
                <br />
                <br />I highly recommend David for any role where technical
                expertise, teamwork, and a user-focused approach are critical.
                He would be an outstanding asset to any organization.”
              </p>
              ...
              >
                — <strong>Andrea Gallimore</strong>
              </a>
            </div>
          </div>
          <div className="wp-block-columns alignwide is-layout-flex wp-container-core-columns-layout-31 wp-block-columns-is-layout-flex">
