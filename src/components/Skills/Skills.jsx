			...
			>
				...
				>
					<div className='wp-block-group alignwide is-vertical is-content-justification-center is-layout-flex wp-container-core-group-layout-28 wp-block-group-is-layout-flex'>
						...
						>
							Adaptability, Angular, Attention to Detail,
							Axios, AWS, Communication, CSS, D3, Django,
							Docker, Express, Git, HTML5, JavaScript,
							Jenkins, Jest, Mongoose, MongoDB, Node,
							Prettier, PostgreSQL, Python, React, Redux,
							RxJS, SASS, TypeScript, Web Design, Webpack,
							etc…
						</h2>
					</div>
				</div>
