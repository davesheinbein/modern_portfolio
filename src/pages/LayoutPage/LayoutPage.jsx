...
export default class Layout extends Component {
  render(props) {
    ...
    const headshot = findImageByName(imgList, targetImageName1);
    const targetImageName2 = "funfunctions";
    const funfunctions = findImageByName(imgList, targetImageName2);
    const targetImageName3 = "fakeflix";
    const fakeflix = findImageByName(imgList, targetImageName3);
    const targetImageName4 = "frushley";
    const frushley = findImageByName(imgList, targetImageName4);
    const targetImageName5 = "fakeamazon";
    const fakeamazon = findImageByName(imgList, targetImageName5);
    const targetImageName6 = "typescriptquiz";
    const typescriptquiz = findImageByName(imgList, targetImageName6);
    const targetImageName7 = "fakespotify";
    const fakeSpotify = findImageByName(imgList, targetImageName7);
    const targetImageName8 = "covidtracker";
    const covidtracker = findImageByName(imgList, targetImageName8);
    const targetImageName9 = "faketwitch";
    const fakeTwitch = findImageByName(imgList, targetImageName9);
    const targetImageName10 = "imessage";
    const imessage = findImageByName(imgList, targetImageName10);

    const targetImageName11 = "code_comp";
    const code_comp = findImageByName(imgList, targetImageName11);

    const targetImageName12 = "comp_code";
    const comp_code = findImageByName(imgList, targetImageName12);

    const targetImageName13 = "desk_comp";
    const desk_comp = findImageByName(imgList, targetImageName13);

    const targetImageName14 = "message";
    const message = findImageByName(imgList, targetImageName14);

    const targetImageName15 = "cat_dog";
    const cat_dog = findImageByName(imgList, targetImageName15);

    const targetImageName16 = "logo_red";
    const logo_red = findImageByName(imgList, targetImageName16);

    const targetImageName17 = "laptop_code";
    const laptop_code = findImageByName(imgList, targetImageName17);

    const targetImageName18 = "logo_blue";
    const logo_blue = findImageByName(imgList, targetImageName18);

    const targetImageName19 = "laptop";
    const laptop = findImageByName(imgList, targetImageName19);
    const targetImageName20 = "marketing";
    const marketing = findImageByName(imgList, targetImageName20);

    const targetImageName21 = "assistant";
    const assistant = findImageByName(imgList, targetImageName21);

    const targetImageName22 = "responsiveDesignImg";
    const responsiveDesign = findImageByName(imgList, targetImageName22);

    const targetImageName23 = "harnessingDesignImg";
    const harnessingDesign = findImageByName(imgList, targetImageName23);

    const targetImageName24 = "importanceImg";
    const importance = findImageByName(imgList, targetImageName24);

    const targetImageName25 = "angularVsReactImg";
    const angularVsReact = findImageByName(imgList, targetImageName25);
    ...
    return (
      <main className="wp-block-group is-layout-flow wp-container-core-group-layout-45 wp-block-group-is-layout-flow">
        ...
        <Education codeCompImg={codeCompImg} compCodeImg={compCodeImg} />
        ...
        <Contact handleThemeChange={this.props.handleThemeChange} />
        <Footer />
      </main>
    );
  }
